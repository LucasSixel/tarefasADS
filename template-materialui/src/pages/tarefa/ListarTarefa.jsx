...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        <Button onClick={() => handleEditar(row.idTarefa)}><EditIcon fontSize="small" /></Button>            
                      </TableCell>
                      <TableCell align="center">
        ...
        <CardActions>
            <Button size="small" variant="contained" onClick={handleOpen} color="success" endIcon={<SendIcon />}>Criar Tarefa</Button>
